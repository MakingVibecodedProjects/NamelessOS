[← 3](PROMPT_3.md) | [index](README.md) | **4** | [5 →](PROMPT_5.md)
...
- IRQ stubs: `sub rsp, 8` before `call irq_dispatch` to maintain 16-byte stack alignment
...
[PROMPT_5 →](PROMPT_5.md) — PMM: Multiboot2 memory map parser, bitmap frame allocator.
